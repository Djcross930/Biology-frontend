...
<template>
  <div class="about">
    ...
    <h2>(Don't worry, there still some variation that inevitably sets you apart)</h2>
    <p> Humans have 22 chromosome pairs, but if you count the two individual sex chromosomes, it comes out to 24 total.
    </p>
    ...
    <select onchange="loadSV(event.target.value)">
      ...
      <option value="NC_000023">Chromosome 23</option>
    </select>
    ...
    <button v-on:click="showHidden()">First Time using the Chromosome Selector?</button>
    <div v-show="value2">I'm not rendered!</div>
  </div>
</template>
